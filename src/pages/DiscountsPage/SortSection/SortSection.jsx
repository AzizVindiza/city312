...
const SortSection = () => {
    ...
    return (
        <div className={'sortSection-1'}>
            <div className="container sortSection-1__container">
                <div onClick={() => setOpen(!open)} className="sortSection-1__block">
                    <h2   className="sortSection-1__h2">{choose}</h2>
                    <div className="sortSection-1__svg">
                ...
                {
                    open ?
                        <ul className="sortSection-1__ul">
                            {
                                sort.map((item,i) => (
                                    <li onClick={() => chooseCategory(item) } className="sortSection-1__item">{item}</li>
                                ))
                            }
                        </ul> : ''
                }
