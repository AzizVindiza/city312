...
<path d="M11.3502 8.07486C9.18194 8.07486 7.42419 9.83261 7.42419 12.0009C7.42419 14.1692 9.18194 15.9269 11.3502 15.9269C13.5185 15.9269 15.2763 14.1692 15.2763 12.0009C15.2763 9.83261 13.5185 8.07486 11.3502 8.07486Z" fill="white"/>
<path fillRule="evenodd" clipRule="evenodd" d="M5.03177 1.22721C9.19714 0.761666 13.5034 0.761666 17.6687 1.22721C19.962 1.48352 21.8117 3.29043 22.0809 5.59176C22.5789 9.85001 22.5789 14.1518 22.0809 18.41C21.8117 20.7114 19.962 22.5183 17.6687 22.7746C13.5034 23.2401 9.19714 23.2401 5.03177 22.7746C2.73848 22.5183 0.888785 20.7114 0.619624 18.41C0.121584 14.1518 0.121584 9.85001 0.619624 5.59176C0.888785 3.29043 2.73848 1.48352 5.03177 1.22721ZM17.3903 4.75283C16.7231 4.75283 16.1823 5.29367 16.1823 5.96084C16.1823 6.62801 16.7231 7.16885 17.3903 7.16885C18.0575 7.16885 18.5983 6.62801 18.5983 5.96084C18.5983 5.29367 18.0575 4.75283 17.3903 4.75283ZM5.61218 12.0009C5.61218 8.83186 8.18119 6.26284 11.3502 6.26284C14.5193 6.26284 17.0883 8.83186 17.0883 12.0009C17.0883 15.1699 14.5193 17.739 11.3502 17.739C8.18119 17.739 5.61218 15.1699 5.61218 12.0009Z" fill="white"/>
</svg>
                        ...
                        <div onClick={() => setLine(!line)} className="registerPartner__days">
                            ...
                            <div className="registerPartner__picture">
                                <svg  viewBox="0 0 10 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.75 6.707L5.86863 10V0H4.11863V10L1.23725 6.707L0 8.121L3.75638 12.414C4.08455 12.7889 4.52959 12.9996 4.99363 12.9996C5.45766 12.9996 5.9027 12.7889 6.23087 12.414L9.98725 8.121L8.75 6.707Z" fill="#F8A303"/>
                                </svg>
                            ...
                            </div>
                            {
                                line ?
                                    <ul className="registerPartner__weeks">
                                        {
                                            arr.map((item,index) => (
                                                <li key={index} onClick={() => chooseDay(item)} className="registerPartner__item">{item}</li>
                                            ))
                                        }
                                    </ul>
                                    : ''
